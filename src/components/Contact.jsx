...
const SOCIALS = [
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/surya-p',
    href: 'https://www.linkedin.com/in/surya-p-60b464374',
    icon: (
...
export default function Contact({ onPreviewResume }) {
    ...
    <section id="contact" className="section">
      <div ref={ref} className="reveal">
        ...
        <p className="contact-subtitle">
          I'm excited to start my IT career and apply
          my networking and Linux skills. Open to opportunities!
        </p>
        ...
        <footer className="footer">
          <div className="footer-name">Surya P</div>
          <p className="footer-subtitle">B.Tech Information Technology · Computer Networking · Linux Enthusiast</p>
          <p className="footer-copyright">Designed &amp; Built by Surya P &copy; {new Date().getFullYear()}</p>
        </footer>
      </div>
